            ...
            openOptions: function (options) {
                ...
                if ($.common.isEmpty(options.yes)) {
                    options.yes = function(index, layero) {
                        // by tans 把 options的参数透传到callback
                        //options.callBack(index, layero);
                        $.common.isEmpty(options.callBackParams) ? options.callBack(index, layero) : options.callBack(index, layero,options.callBackParams);
                    }
                }
                var btnCallback = {};
