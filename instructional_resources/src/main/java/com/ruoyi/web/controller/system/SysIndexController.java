...
public class SysIndexController extends BaseController
{
    ...
    public String main(ModelMap mmap)
    {
        ...
        courses.forEach(c -> {
            ...
            courseUsers.setCourseIdStr(c.getId().toString());
            List<CourseUsers> courseUsersList = courseUsersService.selectCourseUsersList(courseUsers);
            c.setRefUsersCount((long)courseUsersList.size());
        });
